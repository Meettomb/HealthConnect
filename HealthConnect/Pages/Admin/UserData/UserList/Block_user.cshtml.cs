...
{
    public class Block_userModel : PageModel
    {
        ...
        public Block_userModel(IEmailService emailService, IOptions<EmailSettings> emailSettings, IConfiguration configuration)
        {
        ...
        public IActionResult OnGet()
        {
            ...
            {
                string query = "SELECT * FROM User_Table WHERE account_approve = 1 AND block = 1 ORDER BY id DESC";
